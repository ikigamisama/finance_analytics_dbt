...
SELECT
    ...
    ROUND(SUM(transaction_amount_abs)::numeric, 2) AS total_volume,
    ROUND(AVG(transaction_amount_abs)::numeric, 2) AS avg_amount,
    COUNT(DISTINCT customer_key) AS unique_customers,
    COUNT(DISTINCT CASE WHEN is_fraud_flag = TRUE THEN transaction_key END) AS fraud_count,
